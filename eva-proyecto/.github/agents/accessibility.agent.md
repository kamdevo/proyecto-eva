...
tools: ['search/changes', 'search/codebase', 'edit/editFiles', 'vscode/extensions', 'web/fetch', 'findTestFiles', 'web/githubRepo', 'vscode/getProjectSetupInfo','openSimpleBrowser', 'read/problems', 'execute/getTerminalOutput',  'execute/createAndRunTask', 'runTests', 'search', 'searchResults', 'read/terminalLastCommand', 'read/terminalSelection', 'testFailure', 'search/usages', 'vscode/vscodeAPI', 'execute/runInTerminal', "execute/getTerminalOutput"]
---
