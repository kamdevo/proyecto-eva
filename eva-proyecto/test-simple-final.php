...
echo "Primer equipo - Código: {$httpCode3}\n";
...
echo "Segundo equipo - Código: {$httpCode4}\n";
...
if ($httpCode2 == 422) {
    ...
    echo "❌ Test 2: FALLÓ - Código: {$httpCode2}\n";
}

if ($httpCode3 == 201 && $httpCode4 == 422) {
    echo "✅ Test 3: CORRECTO - Validación de código único funciona\n";
} else {
    echo "❌ Test 3: FALLÓ - Códigos: {$httpCode3}, {$httpCode4}\n";
}

echo "\n🎯 RESUMEN:\n";
if ($httpCode == 201 && $httpCode2 == 422 && $httpCode3 == 201 && $httpCode4 == 422) {
