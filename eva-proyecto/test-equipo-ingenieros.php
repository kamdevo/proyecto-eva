...
echo "🔍 Verificando equipo con responsable INGENIEROS BIOMEDICOS...\n\n";
...
try {
    ...
    // Encontrar un equipo con ese responsable
    $stmt = $pdo->query("
        ...
        WHERE pm.anio = 2024
        AND pm.responsable = 'INGENIEROS BIOMEDICOS'
        LIMIT 1
    ");
    ...
    if ($equipo) {
        ...
        if ($httpCode === 200) {
            ...
            if (isset($data['data']['data'][0])) {
                ...
                echo "  Nombre: " . ($equipoAPI['equipo']['name'] ?? 'N/A') . "\n";
