...
export default function VistaServiciosPrincipal() {
  ...
  // Datos de ejemplo para servicios (50 servicios)
  const serviciosData = [
    { id: 1, nombre: "ACONDICIONAMIENTO FISICO", zona: "ZONA MOLANO1", piso: "PISO 2", centroCosto: "ADMINISTRACION UES URGENCIAS", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 35, areasAsociadas: 0 },
    { id: 2, nombre: "2004 URGENCIAS SEDE NORTE", zona: "ZONA NORTE", piso: "PISO 1", centroCosto: "ADMINISTRACION UES URGENCIAS", sede: "HUV NORTE", equiposAsociados: 64, areasAsociadas: 8 },
    { id: 3, nombre: "ALMACEN GENERAL", zona: "ZONA CENTRAL", piso: "PISO 1", centroCosto: "ALMACEN GENERAL", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 7, areasAsociadas: 0 },
    { id: 4, nombre: "ALMACEN GENERAL Y COMPRAS", zona: "ZONA CENTRAL", piso: "PISO 3", centroCosto: "ALMACEN GENERAL", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 4, areasAsociadas: 1 },
    { id: 5, nombre: "AMBULANCIA", zona: "ZONA MOLANO1", piso: "PISO 1", centroCosto: "GINECOBSTETRICIA", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 56, areasAsociadas: 0 },
    { id: 6, nombre: "AMBULANCIA CARTAGO", zona: "ZONA SUR", piso: "PISO 1", centroCosto: "INVENTARIOS", sede: "HUV CARTAGO", equiposAsociados: 22, areasAsociadas: 0 },
    { id: 7, nombre: "ANA FRANK", zona: "ZONA SALUD1", piso: "PISO 4", centroCosto: "SALA CIRUGIA PEDIATRICA ANA FR", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 94, areasAsociadas: 0 },
    { id: 8, nombre: "ANGAR", zona: "ZONA CENTRAL", piso: "PISO 2", centroCosto: "ALMACEN GENERAL", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 11, areasAsociadas: 0 },
    { id: 9, nombre: "ANGIOGRAFIA", zona: "ZONA MOLANO1", piso: "PISO 1", centroCosto: "HEMODINAMIA", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 5, areasAsociadas: 0 },
    { id: 10, nombre: "ANHELO DE VIDA", zona: "ZONA SALUD1", piso: "PISO 3", centroCosto: "SALA PEDIATRIA GENERAL", sede: "HUV EVARISTO GARCÍA - SEDE PRINCIPAL", equiposAsociados: 70, areasAsociadas: 0 },
  ...
  const filteredData = serviciosData.filter(
    (servicio) =>
      servicio.nombre.toLowerCase().includes(searchTerm.toLowerCase()) ||
      servicio.zona.toLowerCase().includes(searchTerm.toLowerCase()) ||
      servicio.centroCosto.toLowerCase().includes(searchTerm.toLowerCase())
  );
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-200">Gestión de servicios hospitalarios</p>
              </div>
            </div>
            ...
            <div className="w-full">
              <Table className="w-full table-fixed">
                <TableHeader className="bg-slate-100">
                  <TableRow>
                    <TableHead className="font-semibold text-slate-700 w-[30%]">Servicio</TableHead>
                    <TableHead className="font-semibold text-slate-700 w-[35%]">Centro de Costo</TableHead>
                    <TableHead className="font-semibold text-slate-700 text-center w-[20%]">Ubicación</TableHead>
                    <TableHead className="font-semibold text-slate-700 text-center w-[15%]">Acciones</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="text-sm text-gray-600">
                  ...
                  {searchTerm && ` (filtrado de ${serviciosData.length} entradas totales)`}
                </div>
