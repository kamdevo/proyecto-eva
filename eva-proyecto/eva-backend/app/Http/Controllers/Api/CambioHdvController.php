...
/**
 * Controlador CambioHdvController - API Empresarial
 * 
 * Controlador optimizado para la gestión de cambio_hdvs
 ...
 * @version 2.0.0
 */
class CambioHdvController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/cambiohdv",
     *     tags={"CambioHdv"},
     *     summary="Listar cambiohdvs",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en CambioHdvController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = CambioHdv::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en CambioHdvController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/cambiohdv/{id}",
     *     tags={"CambioHdv"},
     *     summary="Obtener cambiohdv",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = CambioHdv::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en CambioHdvController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en CambioHdvController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en CambioHdvController::destroy', ['error' => $e->getMessage()]);
