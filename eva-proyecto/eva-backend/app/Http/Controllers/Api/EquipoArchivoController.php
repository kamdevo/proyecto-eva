...
/**
 * Controlador EquipoArchivoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de equipo_archivos
...
class EquipoArchivoController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/equipoarchivo",
     *     tags={"EquipoArchivo"},
     *     summary="Listar equipoarchivos",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoArchivoController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = EquipoArchivo::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en EquipoArchivoController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/equipoarchivo/{id}",
     *     tags={"EquipoArchivo"},
     *     summary="Obtener equipoarchivo",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = EquipoArchivo::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en EquipoArchivoController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/equipoarchivo/{id}",
     *     tags={"EquipoArchivo"},
     *     summary="Actualizar equipoarchivo",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoArchivoController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/equipoarchivo/{id}",
     *     tags={"EquipoArchivo"},
     *     summary="Eliminar equipoarchivo",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoArchivoController::destroy', ['error' => $e->getMessage()]);
