...
/**
 * Controlador ModuloController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Modulo
...
class ModuloController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en ModuloController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Modulo::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en ModuloController::store', ['error' => $e->getMessage()]);
    ...
    public function show($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ModuloController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ModuloController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ModuloController::destroy', ['error' => $e->getMessage()]);
