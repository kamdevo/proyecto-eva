...
/**
 * Controlador EquipoBajaController - API Empresarial
 * 
 * Controlador optimizado para la gestión de equipo_bajas
...
class EquipoBajaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoBajaController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = EquipoBaja::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en EquipoBajaController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/equipobaja/{id}",
     *     tags={"EquipoBaja"},
     *     summary="Obtener equipobaja",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = EquipoBaja::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en EquipoBajaController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoBajaController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoBajaController::destroy', ['error' => $e->getMessage()]);
