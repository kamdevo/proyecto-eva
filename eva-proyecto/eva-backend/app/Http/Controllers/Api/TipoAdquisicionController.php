...
/**
 * Controlador TipoAdquisicionController - API Empresarial
 * 
 * Controlador optimizado para la gestión de tipo_adquisicions
...
class TipoAdquisicionController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/tipoadquisicion",
     *     tags={"TipoAdquisicion"},
     *     summary="Listar tipoadquisicions",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en TipoAdquisicionController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = TipoAdquisicion::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en TipoAdquisicionController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/tipoadquisicion/{id}",
     *     tags={"TipoAdquisicion"},
     *     summary="Obtener tipoadquisicion",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = TipoAdquisicion::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en TipoAdquisicionController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/tipoadquisicion/{id}",
     *     tags={"TipoAdquisicion"},
     *     summary="Actualizar tipoadquisicion",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en TipoAdquisicionController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/tipoadquisicion/{id}",
     *     tags={"TipoAdquisicion"},
     *     summary="Eliminar tipoadquisicion",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en TipoAdquisicionController::destroy', ['error' => $e->getMessage()]);
