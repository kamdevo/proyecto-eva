...
/**
 * Controlador EstadoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Estado
...
class EstadoController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Estado::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en EstadoController::store', ['error' => $e->getMessage()]);
    ...
    public function show($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoController::destroy', ['error' => $e->getMessage()]);
