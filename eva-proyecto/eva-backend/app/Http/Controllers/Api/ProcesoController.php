...
/**
 * Controlador ProcesoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Proceso
...
class ProcesoController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en ProcesoController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Proceso::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en ProcesoController::store', ['error' => $e->getMessage()]);
    ...
    public function show($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ProcesoController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ProcesoController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ProcesoController::destroy', ['error' => $e->getMessage()]);
