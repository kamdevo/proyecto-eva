...
/**
 * Controlador EquipoManualController - API Empresarial
 * 
 * Controlador optimizado para la gestión de equipo_manuales
 ...
 * @version 2.0.0
 */
class EquipoManualController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/equipomanual",
     *     tags={"EquipoManual"},
     *     summary="Listar equipomanuals",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoManualController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = EquipoManual::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en EquipoManualController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/equipomanual/{id}",
     *     tags={"EquipoManual"},
     *     summary="Obtener equipomanual",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = EquipoManual::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en EquipoManualController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/equipomanual/{id}",
     *     tags={"EquipoManual"},
     *     summary="Actualizar equipomanual",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoManualController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EquipoManualController::destroy', ['error' => $e->getMessage()]);
