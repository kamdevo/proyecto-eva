...
/**
 * Controlador ZonaController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Zona
...
class ZonaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en ZonaController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Zona::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en ZonaController::store', ['error' => $e->getMessage()]);
    ...
    public function show($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ZonaController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ZonaController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ZonaController::destroy', ['error' => $e->getMessage()]);
