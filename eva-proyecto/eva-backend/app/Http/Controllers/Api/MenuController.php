...
/**
 * Controlador MenuController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Menu
...
class MenuController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en MenuController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en MenuController::store', ['error' => $e->getMessage()]);
    ...
    public function show($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en MenuController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en MenuController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en MenuController::destroy', ['error' => $e->getMessage()]);
