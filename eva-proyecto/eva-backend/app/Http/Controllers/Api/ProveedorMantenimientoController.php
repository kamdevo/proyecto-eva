...
/**
 * Controlador ProveedorMantenimientoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de proveedor_mantenimientos
...
class ProveedorMantenimientoController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/proveedormantenimiento",
     *     tags={"ProveedorMantenimiento"},
     *     summary="Listar proveedormantenimientos",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $query = ProveedorMantenimiento::query();
            ...
            Log::error('Error en ProveedorMantenimientoController::index', ['error' => $e->getMessage()]);
     ...
     *     path="/api/proveedormantenimiento",
     *     tags={"ProveedorMantenimiento"},
     *     summary="Crear proveedormantenimiento",
     *     security={{"sanctum": {}}},
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = ProveedorMantenimiento::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en ProveedorMantenimientoController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/proveedormantenimiento/{id}",
     *     tags={"ProveedorMantenimiento"},
     *     summary="Obtener proveedormantenimiento",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = ProveedorMantenimiento::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en ProveedorMantenimientoController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/proveedormantenimiento/{id}",
     *     tags={"ProveedorMantenimiento"},
     *     summary="Actualizar proveedormantenimiento",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ProveedorMantenimientoController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/proveedormantenimiento/{id}",
     *     tags={"ProveedorMantenimiento"},
     *     summary="Eliminar proveedormantenimiento",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ProveedorMantenimientoController::destroy', ['error' => $e->getMessage()]);
