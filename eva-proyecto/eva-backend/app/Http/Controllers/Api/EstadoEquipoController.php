...
/**
 * Controlador EstadoEquipoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de estado_equipos
...
class EstadoEquipoController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoEquipoController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = EstadoEquipo::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en EstadoEquipoController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/estadoequipo/{id}",
     *     tags={"EstadoEquipo"},
     *     summary="Obtener estadoequipo",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = EstadoEquipo::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en EstadoEquipoController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/estadoequipo/{id}",
     *     tags={"EstadoEquipo"},
     *     summary="Actualizar estadoequipo",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoEquipoController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoEquipoController::destroy', ['error' => $e->getMessage()]);
