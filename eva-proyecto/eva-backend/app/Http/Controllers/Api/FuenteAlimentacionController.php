...
/**
 * Controlador FuenteAlimentacionController - API Empresarial
 * 
 * Controlador optimizado para la gestión de fuente_alimentacions
 ...
 * @version 2.0.0
 */
class FuenteAlimentacionController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/fuentealimentacion",
     *     tags={"FuenteAlimentacion"},
     *     summary="Listar fuentealimentacions",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en FuenteAlimentacionController::index', ['error' => $e->getMessage()]);
     ...
     *     path="/api/fuentealimentacion",
     *     tags={"FuenteAlimentacion"},
     *     summary="Crear fuentealimentacion",
     *     security={{"sanctum": {}}},
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = FuenteAlimentacion::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en FuenteAlimentacionController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/fuentealimentacion/{id}",
     *     tags={"FuenteAlimentacion"},
     *     summary="Obtener fuentealimentacion",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = FuenteAlimentacion::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en FuenteAlimentacionController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/fuentealimentacion/{id}",
     *     tags={"FuenteAlimentacion"},
     *     summary="Actualizar fuentealimentacion",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en FuenteAlimentacionController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/fuentealimentacion/{id}",
     *     tags={"FuenteAlimentacion"},
     *     summary="Eliminar fuentealimentacion",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en FuenteAlimentacionController::destroy', ['error' => $e->getMessage()]);
