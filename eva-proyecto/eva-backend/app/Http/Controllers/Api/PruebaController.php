...
/**
 * Controlador PruebaController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Prueba
...
class PruebaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en PruebaController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Prueba::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en PruebaController::store', ['error' => $e->getMessage()]);
    ...
    {
        try {
            $item = Prueba::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en PruebaController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en PruebaController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en PruebaController::destroy', ['error' => $e->getMessage()]);
