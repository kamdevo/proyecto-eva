...
/**
 * Controlador ClasificacionRiesgoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de ClasificacionRiesgo
...
class ClasificacionRiesgoController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/clasificacionriesgo",
     *     tags={"ClasificacionRiesgo"},
     *     summary="Listar clasificacionriesgos",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $query = ClasificacionRiesgo::query();
            ...
            Log::error('Error en ClasificacionRiesgoController::index', ['error' => $e->getMessage()]);
     ...
     *     path="/api/clasificacionriesgo",
     *     tags={"ClasificacionRiesgo"},
     *     summary="Crear clasificacionriesgo",
     *     security={{"sanctum": {}}},
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = ClasificacionRiesgo::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en ClasificacionRiesgoController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/clasificacionriesgo/{id}",
     *     tags={"ClasificacionRiesgo"},
     *     summary="Obtener clasificacionriesgo",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = ClasificacionRiesgo::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en ClasificacionRiesgoController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/clasificacionriesgo/{id}",
     *     tags={"ClasificacionRiesgo"},
     *     summary="Actualizar clasificacionriesgo",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ClasificacionRiesgoController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/clasificacionriesgo/{id}",
     *     tags={"ClasificacionRiesgo"},
     *     summary="Eliminar clasificacionriesgo",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en ClasificacionRiesgoController::destroy', ['error' => $e->getMessage()]);
