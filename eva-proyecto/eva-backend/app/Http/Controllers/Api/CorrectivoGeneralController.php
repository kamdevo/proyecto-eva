...
/**
 * Controlador CorrectivoGeneralController - API Empresarial
 * 
 * Controlador optimizado para la gestión de correctivo_generals
...
class CorrectivoGeneralController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/correctivogeneral",
     *     tags={"CorrectivoGeneral"},
     *     summary="Listar correctivogenerals",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en CorrectivoGeneralController::index', ['error' => $e->getMessage()]);
     ...
     *     path="/api/correctivogeneral",
     *     tags={"CorrectivoGeneral"},
     *     summary="Crear correctivogeneral",
     *     security={{"sanctum": {}}},
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = CorrectivoGeneral::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en CorrectivoGeneralController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/correctivogeneral/{id}",
     *     tags={"CorrectivoGeneral"},
     *     summary="Obtener correctivogeneral",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = CorrectivoGeneral::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en CorrectivoGeneralController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/correctivogeneral/{id}",
     *     tags={"CorrectivoGeneral"},
     *     summary="Actualizar correctivogeneral",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en CorrectivoGeneralController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/correctivogeneral/{id}",
     *     tags={"CorrectivoGeneral"},
     *     summary="Eliminar correctivogeneral",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en CorrectivoGeneralController::destroy', ['error' => $e->getMessage()]);
