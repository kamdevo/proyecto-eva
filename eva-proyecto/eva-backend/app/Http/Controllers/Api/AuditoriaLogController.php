...
/**
 * Controlador AuditoriaLogController - API Empresarial
 * 
 * Controlador optimizado para la gestión de auditoria_logs
...
class AuditoriaLogController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/auditorialog",
     *     tags={"AuditoriaLog"},
     *     summary="Listar auditorialogs",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en AuditoriaLogController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = AuditoriaLog::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en AuditoriaLogController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/auditorialog/{id}",
     *     tags={"AuditoriaLog"},
     *     summary="Obtener auditorialog",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = AuditoriaLog::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en AuditoriaLogController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/auditorialog/{id}",
     *     tags={"AuditoriaLog"},
     *     summary="Actualizar auditorialog",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en AuditoriaLogController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en AuditoriaLogController::destroy', ['error' => $e->getMessage()]);
