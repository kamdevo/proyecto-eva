...
/**
 * Controlador UsuarioZonaController - API Empresarial
 * 
 * Controlador optimizado para la gestión de usuario_zonas
 ...
 * @version 2.0.0
 */
class UsuarioZonaController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/usuariozona",
     *     tags={"UsuarioZona"},
     *     summary="Listar usuariozonas",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en UsuarioZonaController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = UsuarioZona::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en UsuarioZonaController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/usuariozona/{id}",
     *     tags={"UsuarioZona"},
     *     summary="Obtener usuariozona",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = UsuarioZona::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en UsuarioZonaController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/usuariozona/{id}",
     *     tags={"UsuarioZona"},
     *     summary="Actualizar usuariozona",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en UsuarioZonaController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en UsuarioZonaController::destroy', ['error' => $e->getMessage()]);
