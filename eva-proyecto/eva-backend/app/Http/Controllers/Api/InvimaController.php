...
/**
 * Controlador InvimaController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Invima
 ...
 * @version 2.0.0
 */
class InvimaController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/invima",
     *     tags={"Invima"},
     *     summary="Listar invimas",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en InvimaController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Invima::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en InvimaController::store', ['error' => $e->getMessage()]);
    ...
    {
        try {
            $item = Invima::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en InvimaController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en InvimaController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en InvimaController::destroy', ['error' => $e->getMessage()]);
