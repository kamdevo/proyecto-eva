...
class IndustrialTicketExportController extends Controller
{
    public function export(Request $request)
    {
        try {
            ...
            $stats = DB::table('ordenes')
                ...
                ->where('ordenes.subproceso_id', 2) // 2 = Industrial
            ...
            $sheet->setTitle('Estadísticas Industriales');
            ...
            // Subtítulo
            $sheet->setCellValue('A2', 'CONSOLIDADO DE TICKETS INDUSTRIALES POR CATEGORÍA (' . $year . ')');
            ...
            $filename = 'Consolidado_Tickets_Industriales_' . $year . '.xlsx';
            ...
            Log::error('Error exportando stats industriales: ' . $e->getMessage());
