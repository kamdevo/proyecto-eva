...
/**
 * Controlador SubprocesoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Subproceso
...
class SubprocesoController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en SubprocesoController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Subproceso::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en SubprocesoController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/subproceso/{id}",
     *     tags={"Subproceso"},
     *     summary="Obtener subproceso",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = Subproceso::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en SubprocesoController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en SubprocesoController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en SubprocesoController::destroy', ['error' => $e->getMessage()]);
