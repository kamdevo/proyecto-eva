...
/**
 * Controlador EstadoMantenimientoController - API Empresarial
 * 
 * Controlador optimizado para la gestión de estado_mantenimientos
...
class EstadoMantenimientoController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/estadomantenimiento",
     *     tags={"EstadoMantenimiento"},
     *     summary="Listar estadomantenimientos",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $query = EstadoMantenimiento::query();
            ...
            Log::error('Error en EstadoMantenimientoController::index', ['error' => $e->getMessage()]);
     ...
     *     path="/api/estadomantenimiento",
     *     tags={"EstadoMantenimiento"},
     *     summary="Crear estadomantenimiento",
     *     security={{"sanctum": {}}},
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = EstadoMantenimiento::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en EstadoMantenimientoController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/estadomantenimiento/{id}",
     *     tags={"EstadoMantenimiento"},
     *     summary="Obtener estadomantenimiento",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = EstadoMantenimiento::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en EstadoMantenimientoController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/estadomantenimiento/{id}",
     *     tags={"EstadoMantenimiento"},
     *     summary="Actualizar estadomantenimiento",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoMantenimientoController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/estadomantenimiento/{id}",
     *     tags={"EstadoMantenimiento"},
     *     summary="Eliminar estadomantenimiento",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EstadoMantenimientoController::destroy', ['error' => $e->getMessage()]);
