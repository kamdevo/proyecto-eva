...
/**
 * Controlador EspecificacionController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Especificacion
...
class EspecificacionController extends Controller
{
     ...
     *     tags={"Especificacion"},
     *     summary="Listar especificacions",
     *     security={{"sanctum": {}}},
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en EspecificacionController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $item = Especificacion::create($data);

            return ResponseFormatter::success($item, 'Creado exitosamente', 201);

        } catch (Exception $e) {
            Log::error('Error en EspecificacionController::store', ['error' => $e->getMessage()]);
     ...
     *     tags={"Especificacion"},
     *     summary="Obtener especificacion",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = Especificacion::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en EspecificacionController::show', ['error' => $e->getMessage()]);
     ...
     *     path="/api/especificacion/{id}",
     *     tags={"Especificacion"},
     *     summary="Actualizar especificacion",
     *     security={{"sanctum": {}}},
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EspecificacionController::update', ['error' => $e->getMessage()]);
     ...
     *     path="/api/especificacion/{id}",
     *     tags={"Especificacion"},
     *     summary="Eliminar especificacion",
     *     security={{"sanctum": {}}},
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en EspecificacionController::destroy', ['error' => $e->getMessage()]);
