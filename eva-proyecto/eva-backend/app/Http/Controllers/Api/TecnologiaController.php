...
/**
 * Controlador TecnologiaController - API Empresarial
 * 
 * Controlador optimizado para la gestión de Tecnologia
...
class TecnologiaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en TecnologiaController::index', ['error' => $e->getMessage()]);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('Error en TecnologiaController::store', ['error' => $e->getMessage()]);
    ...
    /**
     * @OA\Get(
     *     path="/api/tecnologia/{id}",
     *     tags={"Tecnologia"},
     *     summary="Obtener tecnologia",
     *     security={{"sanctum": {}}},
    ...
    {
        try {
            $item = Tecnologia::findOrFail($id);
            return ResponseFormatter::success($item, 'Obtenido exitosamente');

        } catch (Exception $e) {
            Log::error('Error en TecnologiaController::show', ['error' => $e->getMessage()]);
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            Log::error('Error en TecnologiaController::update', ['error' => $e->getMessage()]);
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            Log::error('Error en TecnologiaController::destroy', ['error' => $e->getMessage()]);
