...
/**
 * Modelo EstadoEquipo - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla estado_equipos
...
class EstadoEquipo extends Model
{
    ...
    const CACHE_PREFIX = 'estado_equipos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EstadoEquipo", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EstadoEquipo', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en estado_equipos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en estado_equipos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en estado_equipos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
