...
/**
 * Modelo Orden - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla ordenes
...
class Orden extends Model
{
    ...
    protected $fillable = [
        ...
        'file_diagnostico',
        'file_cierre',
        'fecha_solicitud_repuesto',
        'fecha_recepcion_repuesto',
        'marca_equipo',
        'prioridad',
        'repuesto_pendiente',
        'repuesto_pendiente_condicion',
        'repuestos_usados',
        'centro_costo',
        'nombre_reportante',
        'tecnico_cierre_text',
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Orden", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Orden', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en ordenes", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en ordenes", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en ordenes", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
