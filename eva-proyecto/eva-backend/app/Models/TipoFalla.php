...
/**
 * Modelo TipoFalla - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla tipo_fallas
...
class TipoFalla extends Model
{
    ...
    const CACHE_PREFIX = 'tipo_fallas_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo TipoFalla", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('TipoFalla', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en tipo_fallas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en tipo_fallas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en tipo_fallas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
