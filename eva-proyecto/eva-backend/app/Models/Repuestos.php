...
/**
 * Modelo Repuestos - Gestión Empresarial
 * 
 * Modelo empresarial optimizado para la gestión de repuestos
...
class Repuestos extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            Log::info("Creando registro en repuestos", ['data' => $model->toArray()]);
        });
        
        static::updating(function ($model) {
            $model->limpiarCache();
            Log::info("Actualizando registro en repuestos", ['id' => $model->id, 'cambios' => $model->getDirty()]);
        });
        
        static::deleting(function ($model) {
            $model->limpiarCache();
            Log::warning("Eliminando registro en repuestos", ['id' => $model->id]);
        });
    }
}
