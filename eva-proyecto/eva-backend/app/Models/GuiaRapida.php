...
/**
 * Modelo GuiaRapida - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla guias_rapidas
...
class GuiaRapida extends Model
{
    ...
    const CACHE_PREFIX = 'guias_rapidas_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo GuiaRapida", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('GuiaRapida', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en guias_rapidas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en guias_rapidas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en guias_rapidas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
