...
/**
 * Modelo CambioUbicacion - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla cambio_ubicacions
...
class CambioUbicacion extends Model
{
    ...
    protected $table = 'cambio_ubicacions';
    ...
    const CACHE_PREFIX = 'cambio_ubicacions_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo CambioUbicacion", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('CambioUbicacion', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en cambio_ubicacions", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en cambio_ubicacions", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en cambio_ubicacions", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
