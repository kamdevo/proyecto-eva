...
/**
 * Modelo AvanceCorrectivo - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla avances_correctivos
 ...
 * @since 2024-01-01
 */
class AvanceCorrectivo extends Model
{
    use HasFactory;
    ...
    const CACHE_PREFIX = 'avances_correctivos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo AvanceCorrectivo", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('AvanceCorrectivo', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en avances_correctivos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en avances_correctivos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en avances_correctivos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
