...
/**
 * Modelo Equipment - Gestión Empresarial
 * 
 * Modelo empresarial optimizado para la gestión de equipments
...
class Equipment extends Model
{
    ...
    const CACHE_PREFIX = 'equipments_';
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            Log::info("Creando nuevo registro en equipments", [
        ...
        static::updating(function ($model) {
            ...
            Log::info("Actualizando registro en equipments", [
                'id' => $model->id,
        ...
        static::deleting(function ($model) {
            ...
            Log::warning("Eliminando registro en equipments", [
                'id' => $model->id,
                'data' => $model->toArray()
            ]);
        });
