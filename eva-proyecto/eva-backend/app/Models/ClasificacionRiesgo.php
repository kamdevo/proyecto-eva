...
/**
 * Modelo ClasificacionRiesgo - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla criesgo
...
class ClasificacionRiesgo extends Model
{
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo ClasificacionRiesgo", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('ClasificacionRiesgo', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en criesgo", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en criesgo", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en criesgo", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
