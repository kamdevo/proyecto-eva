...
/**
 * Modelo EquipoManual - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla equipo_manuales
 ...
 * @since 2024-01-01
 */
class EquipoManual extends Model
{
    use HasFactory;
    ...
    protected $table = 'equipo_manuales';
    ...
    const CACHE_PREFIX = 'equipo_manuales_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EquipoManual", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EquipoManual', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en equipo_manuales", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en equipo_manuales", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en equipo_manuales", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
