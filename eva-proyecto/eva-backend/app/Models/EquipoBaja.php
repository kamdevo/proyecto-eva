...
/**
 * Modelo EquipoBaja - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla equipo_bajas
...
class EquipoBaja extends Model
{
    ...
    const CACHE_PREFIX = 'equipo_bajas_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EquipoBaja", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EquipoBaja', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en equipo_bajas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en equipo_bajas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en equipo_bajas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
