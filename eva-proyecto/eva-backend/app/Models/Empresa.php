...
/**
 * Modelo Empresa - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de empresas
...
class Empresa extends Model
{
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo Empresa
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Empresa", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo Empresa
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en empresas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en empresas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en empresas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Empresa', 0, 3));
