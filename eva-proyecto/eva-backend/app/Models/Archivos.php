...
/**
 * Modelo Archivos - Gestión Empresarial
 * 
 * Modelo empresarial optimizado para la gestión de archivos
...
class Archivos extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            Log::info("Creando registro en archivos", ['data' => $model->toArray()]);
        });
        
        static::updating(function ($model) {
            $model->limpiarCache();
            Log::info("Actualizando registro en archivos", ['id' => $model->id, 'cambios' => $model->getDirty()]);
        });
        
        static::deleting(function ($model) {
            $model->limpiarCache();
            Log::warning("Eliminando registro en archivos", ['id' => $model->id]);
        });
    }
}
