...
/**
 * Modelo ServicioIndustrial - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla servicio_industrials
 ...
 * @since 2024-01-01
 */
class ServicioIndustrial extends Model
{
    use HasFactory;
    ...
    protected $table = 'servicio_industrials';
    ...
    const CACHE_PREFIX = 'servicio_industrials_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo ServicioIndustrial", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('ServicioIndustrial', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en servicio_industrials", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en servicio_industrials", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en servicio_industrials", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
