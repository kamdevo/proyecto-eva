...
/**
 * Modelo ProveedorMantenimiento - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla proveedor_mantenimientos
...
class ProveedorMantenimiento extends Model
{
    ...
    const CACHE_PREFIX = 'proveedor_mantenimientos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo ProveedorMantenimiento", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('ProveedorMantenimiento', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en proveedor_mantenimientos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en proveedor_mantenimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en proveedor_mantenimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
