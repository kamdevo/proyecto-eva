...
/**
 * Modelo Repuesto - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla repuestos
...
class Repuesto extends Model
{
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Repuesto", [
                'id' => $this->id,
    ...
    protected static function boot()
    {
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en repuestos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en repuestos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
