...
/**
 * Modelo Permiso - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de permisos
...
class Permiso extends Model
{
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo Permiso
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Permiso", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo Permiso
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en permisos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en permisos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en permisos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Permiso', 0, 3));
