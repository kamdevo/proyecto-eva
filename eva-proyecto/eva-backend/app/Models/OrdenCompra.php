...
/**
 * Modelo OrdenCompra - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla orden_compras
...
class OrdenCompra extends Model
{
    ...
    const CACHE_PREFIX = 'orden_compras_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo OrdenCompra", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('OrdenCompra', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en orden_compras", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en orden_compras", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en orden_compras", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
