...
/**
 * Modelo EquipoIndustrial - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de equipo_industrials
 ...
 * @since 2024-01-01
 */
class EquipoIndustrial extends Model
{
    use HasFactory;
    ...
    protected $table = 'equipo_industrials';
    ...
    const CACHE_PREFIX = 'equipo_industrials_';
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo EquipoIndustrial
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EquipoIndustrial", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo EquipoIndustrial
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en equipo_industrials", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en equipo_industrials", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en equipo_industrials", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EquipoIndustrial', 0, 3));
