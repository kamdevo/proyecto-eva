...
/**
 * Modelo RiesgoIncluidoGuia - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla riesgo_incluido_guias
 ...
 * @since 2024-01-01
 */
class RiesgoIncluidoGuia extends Model
{
    use HasFactory;
    ...
    protected $table = 'riesgo_incluido_guias';
    ...
    const CACHE_PREFIX = 'riesgo_incluido_guias_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo RiesgoIncluidoGuia", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('RiesgoIncluidoGuia', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en riesgo_incluido_guias", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en riesgo_incluido_guias", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en riesgo_incluido_guias", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
