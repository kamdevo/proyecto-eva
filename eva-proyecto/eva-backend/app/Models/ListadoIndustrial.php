...
/**
 * Modelo ListadoIndustrial - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla listado_industrials
 ...
 * @since 2024-01-01
 */
class ListadoIndustrial extends Model
{
    use HasFactory;
    ...
    protected $table = 'listado_industrials';
    ...
    const CACHE_PREFIX = 'listado_industrials_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo ListadoIndustrial", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('ListadoIndustrial', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en listado_industrials", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en listado_industrials", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en listado_industrials", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
