...
/**
 * Modelo CalibracionInd - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla calibracion_inds
 ...
 * @since 2024-01-01
 */
class CalibracionInd extends Model
{
    use HasFactory;
    ...
    protected $table = 'calibracion_inds';
    ...
    const CACHE_PREFIX = 'calibracion_inds_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo CalibracionInd", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('CalibracionInd', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en calibracion_inds", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en calibracion_inds", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en calibracion_inds", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
