...
/**
 * Modelo EstadoExcluidoGuia - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla estado_excluido_guias
 ...
 * @since 2024-01-01
 */
class EstadoExcluidoGuia extends Model
{
    use HasFactory;
    ...
    protected $table = 'estado_excluido_guias';
    ...
    const CACHE_PREFIX = 'estado_excluido_guias_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EstadoExcluidoGuia", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EstadoExcluidoGuia', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en estado_excluido_guias", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en estado_excluido_guias", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en estado_excluido_guias", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
