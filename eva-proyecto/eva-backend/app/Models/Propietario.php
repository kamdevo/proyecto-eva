...
/**
 * Modelo Propietario - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla propietarios
...
class Propietario extends Model
{
    ...
    const CACHE_PREFIX = 'propietarios_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Propietario", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Propietario', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en propietarios", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en propietarios", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en propietarios", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
