...
/**
 * Modelo EquipoRepuesto - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de equipo_repuestos
...
class EquipoRepuesto extends Model
{
    ...
    const CACHE_PREFIX = 'equipo_repuestos_';
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo EquipoRepuesto
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EquipoRepuesto", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo EquipoRepuesto
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en equipo_repuestos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en equipo_repuestos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en equipo_repuestos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
