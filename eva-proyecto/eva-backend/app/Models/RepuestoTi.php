...
/**
 * Modelo RepuestoTi - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla repuesto_tis
 ...
 * @since 2024-01-01
 */
class RepuestoTi extends Model
{
    use HasFactory;
    ...
    const CACHE_PREFIX = 'repuesto_tis_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo RepuestoTi", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('RepuestoTi', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en repuesto_tis", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en repuesto_tis", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en repuesto_tis", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
