...
/**
 * Modelo Prueba - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla pruebas
...
class Prueba extends Model
{
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Prueba", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Prueba', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en pruebas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en pruebas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en pruebas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
