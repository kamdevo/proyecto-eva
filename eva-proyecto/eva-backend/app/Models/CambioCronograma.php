...
/**
 * Modelo CambioCronograma - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla cambio_cronogramas
 ...
 * @since 2024-01-01
 */
class CambioCronograma extends Model
{
    use HasFactory;
    ...
    protected $table = 'cambio_cronogramas';
    ...
    const CACHE_PREFIX = 'cambio_cronogramas_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo CambioCronograma", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('CambioCronograma', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en cambio_cronogramas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en cambio_cronogramas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en cambio_cronogramas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
