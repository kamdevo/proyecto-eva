...
/**
 * Modelo File - Gestión Empresarial
 * 
 * Modelo empresarial optimizado para la gestión de files
...
class File extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            Log::info("Creando nuevo registro en files", [
        ...
        static::updating(function ($model) {
            ...
            Log::info("Actualizando registro en files", [
                'id' => $model->id,
        ...
        static::deleting(function ($model) {
            ...
            Log::warning("Eliminando registro en files", [
                'id' => $model->id,
                'data' => $model->toArray()
            ]);
        });
