...
/**
 * Modelo TipoAdquisicion - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de tipo_adquisicions
...
class TipoAdquisicion extends Model
{
    ...
    protected $table = 'tipo_adquisicions';
    ...
    const CACHE_PREFIX = 'tipo_adquisicions_';
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo TipoAdquisicion
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo TipoAdquisicion", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo TipoAdquisicion
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en tipo_adquisicions", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en tipo_adquisicions", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en tipo_adquisicions", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('TipoAdquisicion', 0, 3));
