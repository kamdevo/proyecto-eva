...
/**
 * Modelo Manual - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de manuals
...
class Manual extends Model
{
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo Manual
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Manual", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo Manual
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en manuals", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en manuals", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en manuals", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Manual', 0, 3));
