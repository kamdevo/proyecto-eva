...
/**
 * Modelo ConsultaGuiaRapida - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla consulta_guia_rapidas
 ...
 * @since 2024-01-01
 */
class ConsultaGuiaRapida extends Model
{
    use HasFactory;
    ...
    protected $table = 'consulta_guia_rapidas';
    ...
    const CACHE_PREFIX = 'consulta_guia_rapidas_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo ConsultaGuiaRapida", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('ConsultaGuiaRapida', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en consulta_guia_rapidas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en consulta_guia_rapidas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en consulta_guia_rapidas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
