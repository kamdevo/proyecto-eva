...
/**
 * Modelo EquipoExcluidoGuia - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla equipo_excluido_guias
 ...
 * @since 2024-01-01
 */
class EquipoExcluidoGuia extends Model
{
    use HasFactory;
    ...
    protected $table = 'equipo_excluido_guias';
    ...
    const CACHE_PREFIX = 'equipo_excluido_guias_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EquipoExcluidoGuia", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EquipoExcluidoGuia', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en equipo_excluido_guias", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en equipo_excluido_guias", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en equipo_excluido_guias", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
