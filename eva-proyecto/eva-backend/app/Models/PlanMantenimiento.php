...
/**
 * Modelo PlanMantenimiento - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla plan_mantenimiento
...
class PlanMantenimiento extends Model
{
    ...
    const CACHE_PREFIX = 'plan_mantenimiento_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo PlanMantenimiento", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('PlanMantenimiento', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en plan_mantenimiento", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en plan_mantenimiento", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en plan_mantenimiento", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
