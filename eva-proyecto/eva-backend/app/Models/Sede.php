...
/**
 * Modelo Sede - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla sedes
...
class Sede extends Model
{
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Sede", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Sede', 0, 3));
