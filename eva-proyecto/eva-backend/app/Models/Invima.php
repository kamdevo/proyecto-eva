...
/**
 * Modelo Invima - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de invimas
...
class Invima extends Model
{
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo Invima
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Invima", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo Invima
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en invimas", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en invimas", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en invimas", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Invima', 0, 3));
