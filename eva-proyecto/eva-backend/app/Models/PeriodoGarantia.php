...
/**
 * Modelo PeriodoGarantia - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla periodo_garantias
 ...
 * @since 2024-01-01
 */
class PeriodoGarantia extends Model
{
    use HasFactory;
    ...
    protected $table = 'periodo_garantias';
    ...
    const CACHE_PREFIX = 'periodo_garantias_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo PeriodoGarantia", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('PeriodoGarantia', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en periodo_garantias", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en periodo_garantias", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en periodo_garantias", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
