...
/**
 * Modelo EquipoContacto - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla equipo_contactos
 ...
 * @since 2024-01-01
 */
class EquipoContacto extends Model
{
    use HasFactory;
    ...
    protected $table = 'equipo_contactos';
    ...
    const CACHE_PREFIX = 'equipo_contactos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EquipoContacto", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EquipoContacto', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en equipo_contactos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en equipo_contactos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en equipo_contactos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
