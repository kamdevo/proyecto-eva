...
/**
 * Modelo Filtros - Gestión Empresarial
 * 
 * Modelo empresarial optimizado para la gestión de filtross
...
class Filtros extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            Log::info("Creando nuevo registro en filtross", [
        ...
        static::updating(function ($model) {
            ...
            Log::info("Actualizando registro en filtross", [
                'id' => $model->id,
        ...
        static::deleting(function ($model) {
            ...
            Log::warning("Eliminando registro en filtross", [
                'id' => $model->id,
                'data' => $model->toArray()
            ]);
        });
