...
/**
 * Modelo GuiaRapidaIndicador - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla guia_rapida_indicadores
 ...
 * @since 2024-01-01
 */
class GuiaRapidaIndicador extends Model
{
    use HasFactory;
    ...
    protected $table = 'guia_rapida_indicadores';
    ...
    const CACHE_PREFIX = 'guia_rapida_indicadores_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo GuiaRapidaIndicador", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('GuiaRapidaIndicador', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en guia_rapida_indicadores", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en guia_rapida_indicadores", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en guia_rapida_indicadores", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
