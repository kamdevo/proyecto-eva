...
/**
 * Modelo CambioHdv - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla cambio_hdvs
...
class CambioHdv extends Model
{
    ...
    const CACHE_PREFIX = 'cambio_hdvs_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo CambioHdv", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('CambioHdv', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en cambio_hdvs", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en cambio_hdvs", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en cambio_hdvs", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
