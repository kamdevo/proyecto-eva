...
/**
 * Modelo TipoCompra - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla tipo_compras
...
class TipoCompra extends Model
{
    ...
    const CACHE_PREFIX = 'tipo_compras_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo TipoCompra", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('TipoCompra', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en tipo_compras", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en tipo_compras", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en tipo_compras", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
