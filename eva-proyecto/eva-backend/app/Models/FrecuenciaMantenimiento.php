...
/**
 * Modelo FrecuenciaMantenimiento - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla frecuencia_mantenimientos
...
class FrecuenciaMantenimiento extends Model
{
    ...
    const CACHE_PREFIX = 'frecuencia_mantenimientos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo FrecuenciaMantenimiento", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('FrecuenciaMantenimiento', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en frecuencia_mantenimientos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en frecuencia_mantenimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en frecuencia_mantenimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
