...
/**
 * Modelo MantenimientoInd - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla mantenimiento_inds
 ...
 * @since 2024-01-01
 */
class MantenimientoInd extends Model
{
    use HasFactory;
    ...
    protected $table = 'mantenimiento_inds';
    ...
    const CACHE_PREFIX = 'mantenimiento_inds_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo MantenimientoInd", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('MantenimientoInd', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en mantenimiento_inds", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en mantenimiento_inds", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en mantenimiento_inds", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
