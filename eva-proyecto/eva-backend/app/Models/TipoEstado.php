...
/**
 * Modelo TipoEstado - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla tipo_estados
...
class TipoEstado extends Model
{
    ...
    const CACHE_PREFIX = 'tipo_estados_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo TipoEstado", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('TipoEstado', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en tipo_estados", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en tipo_estados", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en tipo_estados", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
