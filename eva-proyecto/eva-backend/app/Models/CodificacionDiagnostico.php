...
/**
 * Modelo CodificacionDiagnostico - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla codificacion_diagnosticos
 ...
 * @since 2024-01-01
 */
class CodificacionDiagnostico extends Model
{
    use HasFactory;
    ...
    protected $table = 'codificacion_diagnosticos';
    ...
    const CACHE_PREFIX = 'codificacion_diagnosticos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo CodificacionDiagnostico", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('CodificacionDiagnostico', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en codificacion_diagnosticos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en codificacion_diagnosticos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en codificacion_diagnosticos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
