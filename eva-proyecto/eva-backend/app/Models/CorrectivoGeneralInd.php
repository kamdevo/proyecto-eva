...
/**
 * Modelo CorrectivoGeneralInd - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla correctivo_general_inds
 ...
 * @since 2024-01-01
 */
class CorrectivoGeneralInd extends Model
{
    use HasFactory;
    ...
    protected $table = 'correctivo_general_inds';
    ...
    const CACHE_PREFIX = 'correctivo_general_inds_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo CorrectivoGeneralInd", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('CorrectivoGeneralInd', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en correctivo_general_inds", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en correctivo_general_inds", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en correctivo_general_inds", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
