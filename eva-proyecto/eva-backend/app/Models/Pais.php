...
/**
 * Modelo Pais - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la gestión de pais
...
class Pais extends Model
{
    ...
    public function validarIntegridad(): array
    {
        ...
        // Validaciones específicas del modelo Pais
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Pais", [
                'id' => $this->id,
    ...
    /**
     * Método específico del modelo Pais
     */
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en pais", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en pais", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en pais", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Pais', 0, 3));
