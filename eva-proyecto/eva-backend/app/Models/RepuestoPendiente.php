...
/**
 * Modelo RepuestoPendiente - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla repuesto_pendientes
 ...
 * @since 2024-01-01
 */
class RepuestoPendiente extends Model
{
    use HasFactory;
    ...
    protected $table = 'repuesto_pendientes';
    ...
    const CACHE_PREFIX = 'repuesto_pendientes_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo RepuestoPendiente", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('RepuestoPendiente', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en repuesto_pendientes", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en repuesto_pendientes", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en repuesto_pendientes", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
