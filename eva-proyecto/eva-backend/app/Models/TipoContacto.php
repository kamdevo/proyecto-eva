...
/**
 * Modelo TipoContacto - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla tipo_contactos
...
class TipoContacto extends Model
{
    ...
    const CACHE_PREFIX = 'tipo_contactos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo TipoContacto", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('TipoContacto', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en tipo_contactos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en tipo_contactos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en tipo_contactos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
