...
/**
 * Modelo VigenciaMantenimiento - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla vigencia_mantenimientos
 ...
 * @since 2024-01-01
 */
class VigenciaMantenimiento extends Model
{
    use HasFactory;
    ...
    protected $table = 'vigencia_mantenimientos';
    ...
    const CACHE_PREFIX = 'vigencia_mantenimientos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo VigenciaMantenimiento", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('VigenciaMantenimiento', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en vigencia_mantenimientos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en vigencia_mantenimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en vigencia_mantenimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
