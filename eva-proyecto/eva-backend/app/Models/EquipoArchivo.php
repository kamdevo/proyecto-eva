...
/**
 * Modelo EquipoArchivo - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla equipo_archivos
...
class EquipoArchivo extends Model
{
    ...
    const CACHE_PREFIX = 'equipo_archivos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo EquipoArchivo", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('EquipoArchivo', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en equipo_archivos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en equipo_archivos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en equipo_archivos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
