...
/**
 * Modelo Movimiento - Gestión Empresarial Optimizada
 * 
 * Modelo empresarial optimizado para la tabla movimientos
...
class Movimiento extends Model
{
    ...
    const CACHE_PREFIX = 'movimientos_';
    ...
    public function cambiarEstado(string $nuevoEstado, string $motivo = null): bool
    {
        ...
        if ($resultado) {
            Log::info("Estado cambiado en modelo Movimiento", [
                'id' => $this->id,
    ...
    {
        $prefijo = $prefijo ?? strtoupper(substr('Movimiento', 0, 3));
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            Log::info("Creando nuevo registro en movimientos", [
        ...
        static::updating(function ($model) {
            Log::info("Actualizando registro en movimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
        ...
        static::deleting(function ($model) {
            Log::warning("Eliminando registro en movimientos", [
                'id' => $model->id,
                'modelo' => get_class($model),
                'data' => $model->toArray()
            ]);
