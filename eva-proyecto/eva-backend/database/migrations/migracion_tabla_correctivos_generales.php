...
return new class extends Migration
{
    ...
    {
        Schema::create('correctivos_generales', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('tipo_falla_id')->nullable();
            
            $table->index('equipo_id');
            $table->index('cierre_id');
            $table->index('tipo_falla_id');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('correctivos_generales');
    }
};
