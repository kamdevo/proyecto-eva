          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle>Nuevo Ticket de Trabajo</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="ticket-id">ID</Label>
                      <Input id="ticket-id" placeholder="Automático" disabled />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="ticket-assigned">Asignado a</Label>
                      <Select>
                        <SelectTrigger>
                          <SelectValue placeholder="Seleccionar técnico" />
                        </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input id="ticket-files" type="file" multiple />
            ...
            {/* Rest of action buttons remain the same */}
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Depurar Sistema</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <p className="text-sm text-gray-600">
                    Esta acción limpiará los tickets antiguos y optimizará la
                    base de datos.
                  </p>
                  <div className="flex justify-end gap-2">
                    <Button variant="outline">Cancelar</Button>
                    <Button variant="destructive">Depurar</Button>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  <DialogTitle>Nuevo Orden de Trabajo</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="work-order-id">Número de Orden</Label>
                      <Input
                        id="work-order-id"
                        placeholder="Automático"
                        disabled
                    ...
                    <div>
                      <Label htmlFor="work-order-type">Tipo de Trabajo</Label>
                      <Select>
                        <SelectTrigger>
                          <SelectValue placeholder="Seleccionar tipo" />
                        </SelectTrigger>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <Label htmlFor="work-order-priority">Prioridad</Label>
                      <Select>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="work-order-date">Fecha programada</Label>
                      <Input id="work-order-date" type="date" />
                    </div>
                    <div>
                      <Label htmlFor="work-order-time">Hora estimada</Label>
                      <Input id="work-order-time" placeholder="2 horas" />
                    </div>
                  </div>
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  <DialogTitle>Nuevo Orden de Trabajo Preventivo</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="preventive-equipment">Equipo</Label>
                      <Select>
                        <SelectTrigger>
                          <SelectValue placeholder="Seleccionar equipo" />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="Equipo1">Equipo 1</SelectItem>
                          <SelectItem value="Equipo2">Equipo 2</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    <div>
                      <Label htmlFor="preventive-frequency">Frecuencia</Label>
                      <Select>
                        <SelectTrigger>
                  ...
                  <div>
                    <Label htmlFor="preventive-description">
                      Descripción del mantenimiento
                    </Label>
                    <Textarea
                      id="preventive-description"
                      placeholder="Describa las actividades de mantenimiento preventivo"
                      rows={3}
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="preventive-start-date">
                        Fecha de inicio
                      </Label>
                      <Input id="preventive-start-date" type="date" />
                    </div>
                    <div>
                      <Label htmlFor="preventive-technician">
                        Técnico asignado
                      </Label>
                      <Select>
                        <SelectTrigger>
                  ...
                  <div>
                    <Label htmlFor="preventive-materials">
                      Materiales necesarios
                    </Label>
                    <Textarea
                      id="preventive-materials"
                      placeholder="Liste los materiales y herramientas necesarios"
                      rows={2}
                    />
                  </div>
            ...
            <Dialog>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="calibration-equipment">
                      Equipo a calibrar
                    </Label>
                    <Select>
                      <SelectTrigger>
            ...
            <Dialog>
              <DialogTrigger asChild>
                ...
                >
                  ...
                  Obsoletos por vida útil
                </Button>
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Equipos Obsoletos por Vida Útil</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <p className="text-sm text-gray-600">
                    Revisar equipos que han superado su vida útil recomendada.
                  </p>
                  <div className="flex justify-end gap-2">
                    <Button variant="outline">Cancelar</Button>
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Mantenimiento Correctivo</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="corrective-equipment">Equipo</Label>
                    <Select>
                      <SelectTrigger>
                        <SelectValue placeholder="Seleccionar equipo" />
                      </SelectTrigger>
                  ...
                  <div>
                    <Label htmlFor="corrective-issue">Problema reportado</Label>
                    <Textarea
                      id="corrective-issue"
                  ...
                  <div className="flex justify-end gap-2">
                    <Button variant="outline">Cancelar</Button>
                    <Button>Crear Orden Correctiva</Button>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
