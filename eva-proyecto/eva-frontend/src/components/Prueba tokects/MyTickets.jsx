...
export default function MyTickets() {
  ...
  const loadTickets = async () => {
    try {
      const response = await httpService.get('/api/v1/tickets');
      if (response.success) {
      ...
      setTickets([
        {
          id: "14820",
          origin: "Equipos Biomédicos",
          description: "Mantenimiento preventivo de desfibrilador en urgencias",
          date: "2024-05-08",
          time: "14:30:07",
          status: "Cerrado",
          tipo: "licensed"
        ...
        {
          id: "14819",
          origin: "Equipos Industriales",
          description: "Revisión de compresor en área de producción",
          date: "2024-05-08",
          time: "14:30:07",
          status: "En Proceso",
          tipo: "industrial"
        },
        {
          ...
          description: "Mantenimiento de sistema HVAC en edificio principal",
          date: "2024-05-08",
          time: "14:30:07",
          status: "Abierto",
          tipo: "infrastructure"
    ...
    try {
      ...
      if (response.success) {
        ...
        setFormData(prev => ({
          ...prev,
          [formType]: {
            ...Object.keys(prev[formType]).reduce((acc, key) => {
              acc[key] = key === 'archivos' ? [] : '';
              return acc;
            }, {})
          }
        }));
        ...
        toast.error(response.message || 'Error al crear la orden de trabajo');
      }
    } catch (error) {
