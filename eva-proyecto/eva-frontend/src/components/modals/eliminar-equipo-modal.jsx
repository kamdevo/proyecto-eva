        ...
        <DialogHeader className="border-b border-red-200 pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <DialogTitle className="text-xl font-semibold text-slate-800">Eliminar Equipo</DialogTitle>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <div
            className="h-1 bg-gradient-to-r from-red-400 to-pink-400 rounded-full mt-3"></div>
        </DialogHeader>

        <div className="py-6">
          <div
            className="flex items-center gap-4 p-6 border border-red-200 rounded-xl bg-red-50 mb-6">
            <div
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-red-700">
                Esta acción eliminará permanentemente el equipo y toda su información asociada del sistema de
          ...
          <div className="space-y-4">
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-medium text-slate-800">Información del Equipo a Eliminar</span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-amber-800">
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>Se eliminará el cronograma de mantenimiento programado</li>
                    <li>Se perderán todas las observaciones registradas</li>
                    <li>Se eliminará el historial de mantenimientos realizados</li>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-blue-800">
                  <strong>Alternativa recomendada:</strong> En lugar de eliminar el equipo, considere marcarlo como
                  "Fuera de Servicio" o "Inactivo" para mantener el historial de mantenimiento para futuras referencias.
                </div>
              </div>
            </div>
          </div>
