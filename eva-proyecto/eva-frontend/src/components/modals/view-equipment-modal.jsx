    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="min-w-5xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6 p-3 sm:p-4 md:p-6">
          {/* Equipment Header */}
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-3 sm:p-4 md:p-6 rounded-lg">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-3 sm:p-4 md:p-6 rounded-lg">
            <h3 className="flex items-center gap-2 text-lg font-semibold text-gray-800 mb-4">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              <Badge className="bg-blue-100 text-blue-800 px-3 py-2">
                📋 Guía rápida: ACELERADOR LINEAL VARIAN
              </Badge>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-yellow-700">
                  Esta vista es de solo consulta. Para realizar modificaciones,
                  utilice el botón de editar.
                </p>
              </div>
            </div>
          </div>
