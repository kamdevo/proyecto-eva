...
import { X, Eye, FileText, Download, Calendar, User, AlertCircle } from "lucide-react"
...
const documentacionEjemplo = {
  ...
  historial: [
    ...
    },
    {
      ...
      resultado: "Pendiente",
      observaciones: "Requiere calibración de precisión en el sistema de enfoque",
    },
    {
      id: 3,
      fecha: "2024-05-15",
...
export function VerDocumentacionModal({ open, onOpenChange, equipo }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-5xl mx-auto max-h-[90vh] overflow-y-auto">
        <DialogHeader className="border-b border-orange-200 pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <DialogTitle className="text-xl font-semibold text-slate-800">Documentación Completa</DialogTitle>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <div
            className="h-1 bg-gradient-to-r from-orange-400 to-red-400 rounded-full mt-3"></div>
        </DialogHeader>
        ...
        <div className="py-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-sm">
              <div>
                ...
                <div className="text-slate-900 font-medium">{equipo.equipo}</div>
              </div>
              <div>
          ...
          <Tabs defaultValue="manuales" className="w-full">
            <TabsList className="grid w-full grid-cols-3">
              ...
              <TabsTrigger value="reportes">Reportes de Mantenimiento</TabsTrigger>
              <TabsTrigger value="historial">Historial de Actividades</TabsTrigger>
            </TabsList>

            {/* Tab: Manuales */}
            <TabsContent value="manuales" className="space-y-4 mt-6">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium text-slate-800">Manuales y Documentación Técnica</h3>
                  ...
                  <div
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        ...
                        <h4 className="font-medium text-slate-900 mb-1">{manual.nombre}</h4>
            ...
            <TabsContent value="reportes" className="space-y-4 mt-6">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium text-slate-800">Reportes de Mantenimiento</h3>
                  ...
                  <div
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-700 mt-2">{reporte.observaciones}</p>
                      </div>
                      <div className="flex items-center gap-1">
                        <Button
                          variant="ghost"
            ...
            <TabsContent value="historial" className="space-y-4 mt-6">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium text-slate-800">Historial de Actividades</h3>
                ...
                {documentacionEjemplo.historial.map((actividad, index) => (
                  <div key={actividad.id} className="relative">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div
                        className="flex-1 border border-slate-200 rounded-lg p-4 hover:bg-slate-50">
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              <h4 className="font-medium text-slate-900">{actividad.accion}</h4>
                              <Badge className={getEstadoColor(actividad.resultado)}>{actividad.resultado}</Badge>
                            </div>
                            <div
                              className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-slate-600 mb-2">
                              <div className="flex items-center gap-1">
                                <Calendar className="w-3 h-3" />
                            ...
                            <p className="text-sm text-slate-700">{actividad.observaciones}</p>
                          </div>
                        </div>
                      </div>
                    </div>
