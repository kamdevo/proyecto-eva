          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-6">
            ...
            <div className="space-y-4 text-sm text-slate-700 leading-relaxed">
              <p className="font-medium">
                Para ingresar un registro en el plan de mantenimiento debe
                ingresar en el formulario un archivo de excel plano con una sola
                hoja y teniendo en cuenta las siguientes instrucciones:
              </p>

              <ul className="space-y-3 list-disc list-inside pl-4">
                <li>
                  <strong>
                    La opción reemplazar información subida previamente
                  </strong>{" "}
                  reemplaza un registro del plan según el año seleccionado; es
                  equivalente a actualizar el registro con la diferencia de que
                  si durante el proceso anterior algunos registros, aquellos que
                  no estaban presentes se agregaran al plan.
                </li>

                <li>
                  <strong>Los campos meses</strong> deben ser valores numéricos
                  y deben ser agregados de forma lógica es decir en orden
                  ascendente correspondiente al año.
                </li>

                <li>
                  <strong>El id del equipos</strong> es aquel que identifica
                  inequívocamente al equipo en la base de datos, es decir es el
                  que está asignado en el aplicativo.
                </li>

                <li>
                  <strong>El responsable</strong> es el responsable del
                  mantenimiento, verifique que no sea ingresado el mismo
                  responsable con variación en su nombre o de lo contrario se
                  identificarán como responsables diferentes.
                </li>

                <li>
                  <strong>En la base de datos</strong> aparecen de muestra en la
                  primera fila los nombres a utilizar, estos son informativos,
                  ya que cuando se vaya a subir el archivo estos datos se
                  actualizarán{" "}
