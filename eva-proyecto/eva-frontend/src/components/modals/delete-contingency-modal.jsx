    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-md mx-auto max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          <div
            className="flex items-center gap-3 p-4 border border-red-200 rounded-lg bg-red-50">
          ...
          <div className="space-y-3">
            <div className="bg-slate-50 p-3 rounded-lg border">
              ...
              <div className="space-y-1 text-xs text-slate-600">
                <div>
                  <span className="font-medium">ID:</span> #{contingency.id}
                </div>
                <div>
                  <span className="font-medium">Fecha:</span> {contingency.fecha}
                </div>
                <div>
                  <span className="font-medium">Estado:</span> {contingency.estado}
                </div>
                <div>
          ...
          <div className="bg-amber-50 p-3 rounded-lg border border-amber-200">
            <div className="text-xs sm:text-sm text-amber-800">
              <strong>Nota:</strong> Al eliminar esta contingencia, también se eliminará el archivo asociado y todo el
        ...
        <div
          ...
          <Button
            className="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white px-4 sm:px-6 h-9 text-sm">
