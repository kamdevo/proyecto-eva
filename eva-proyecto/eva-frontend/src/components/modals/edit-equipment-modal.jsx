    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[85vh] overflow-y-auto">
            ...
            <CardContent className="p-3 sm:p-4 md:p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                ...
                <div>
                  ...
                  <Input placeholder="ANUAL" className="mt-1 h-7 sm:h-8 md:h-9 text-xs sm:text-sm" />
                </div>
              ...
              <div>
                <Label className="text-base font-semibold">Estado actual del equipo:</Label>
              ...
              <div>
                <Label className="text-base font-semibold">REGISTRO DE APOYO TÉCNICO</Label>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 mt-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="edit-manual-operacion" className="text-xs sm:text-sm">
                          Operación
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox id="edit-manual-mantenimiento" />
                        <Label htmlFor="edit-manual-mantenimiento" className="text-xs sm:text-sm">
                          Mantenimiento
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox id="edit-manual-partes" />
                        <Label htmlFor="edit-manual-partes" className="text-xs sm:text-sm">
                          Partes
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox id="edit-manual-otros" />
                        <Label htmlFor="edit-manual-otros" className="text-xs sm:text-sm">
                          Otros
                        </Label>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 mt-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="edit-plano-electrico" className="text-xs sm:text-sm">
                          Eléctrico
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox id="edit-plano-electronico" />
                        <Label htmlFor="edit-plano-electronico" className="text-xs sm:text-sm">
                          Electrónico
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox id="edit-plano-neumatico" />
                        <Label htmlFor="edit-plano-neumatico" className="text-xs sm:text-sm">
                          Neumático
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox id="edit-plano-mecanico" />
                        <Label htmlFor="edit-plano-mecanico" className="text-xs sm:text-sm">
                          Mecánico
                        </Label>
                      </div>
                    </div>
        ...
        <div className="flex justify-between p-4 border-t">
          <Button className="bg-green-600 hover:bg-green-700 text-white px-8">Guardar Cambios</Button>
