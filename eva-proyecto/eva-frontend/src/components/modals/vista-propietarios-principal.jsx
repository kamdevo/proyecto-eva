...
// Importar modales
import UIModalAgregarPropietario from "./ui-modal-agregar-propietario"
import UIModalEditarPropietario from "./ui-modal-editar-propietario"
import UIModalEliminarPropietario from "./ui-modal-eliminar-propietario"
import UIModalExaminarPropietario from "./ui-modal-examinar-propietario"
...
export default function VistaPropietariosPrincipal() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="text-center lg:text-left">
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-2">Propietarios</h1>
              <p className="text-base lg:text-lg text-gray-600">Gestión de propietarios y empresas</p>
            </div>
          ...
          <CardContent className="p-4 lg:p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="text-sm lg:text-base text-gray-600 font-medium">
                ...
                de <span className="font-bold text-blue-600">{totalItems}</span> registros
              </div>

              <div className="flex items-center space-x-3">
                <span className="text-sm lg:text-base text-gray-600 font-medium whitespace-nowrap">Mostrar</span>
                ...
                <span className="text-sm lg:text-base text-gray-600 font-medium whitespace-nowrap">por página</span>
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  {currentData.map((propietario, index) => (
                    ...
                    >
                      <TableCell className="py-6 px-6">
                        <div className="font-semibold text-gray-900 text-base">{propietario.nombre}</div>
                        <div className="text-sm text-gray-500 mt-1">{propietario.tipoEmpresa}</div>
                      </TableCell>
                      <TableCell className="py-6 px-6">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-gray-900 text-sm truncate">{propietario.nombre}</h3>
                        <p className="text-xs text-gray-500 mt-1">{propietario.tipoEmpresa}</p>
                      </div>
      ...
      {/* Modales */}
      <UIModalAgregarPropietario isOpen={isAddModalOpen} onClose={() => setIsAddModalOpen(false)} />
