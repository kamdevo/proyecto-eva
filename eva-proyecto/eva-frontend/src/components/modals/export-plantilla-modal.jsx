            ...
            <TabsContent value="descargar" className="space-y-6 mt-6">
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-800">
                      <strong>Información:</strong> Descarga una plantilla vacía
                      para llenar con los datos de mantenimiento preventivo. La
                      plantilla incluye todas las columnas necesarias y el
                      formato correcto.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <Select
                    value={plantillaType}
                    onValueChange={setPlantillaType}
                  >
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm text-red-800">
                        <strong>Subir PDF:</strong> Sube un documento PDF con el
                        cronograma de mantenimiento. El archivo se almacenará y
