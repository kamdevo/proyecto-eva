...
const documentData = [
  ...
  {
    fecha: "2024-06-16",
    descripcion: "Se hace el reporte técnico de mantenimiento preventivo y se documenta la propuesta",
    archivo: "reporte_tecnico.pdf",
    acciones: ["view", "download", "delete"],
  },
  {
    fecha: "2024-06-15",
    descripcion: "DOCUMENTO DE GUÍA, EQUIPO LÁMPARA CIRUGÍA BIOMÉDICA DE QUIRÓFANO 1",
    archivo: "guia_quirofano.pdf",
    acciones: ["view", "download", "delete"],
  },
  {
    fecha: "2024-06-14",
    descripcion: "SE ENTREGA EQUIPO QUE ESTABA INACTIVO, UBICADO EN ÁREA DE MANTENIMIENTO PARA SU APROPIACIÓN",
    archivo: "entrega_equipo.pdf",
    acciones: ["view", "download", "delete"],
  },
]

export function DocumentListModal({ open, onOpenChange, equipment, onUploadClick }) {
  return (
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6 p-2 sm:p-3 md:p-4">
          ...
          <div className="flex gap-2">
            ...
            <Button className="bg-blue-500 hover:bg-blue-600 text-white">Acción 2</Button>
            <Button className="bg-blue-500 hover:bg-blue-600 text-white">Acción 3</Button>
            <Button className="bg-blue-500 hover:bg-blue-600 text-white">Acción 4</Button>
          </div>
          ...
          <div className="overflow-x-auto bg-white rounded-lg shadow">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th
                    className="px-2 py-2 sm:px-3 sm:py-2 md:px-4 md:py-3 text-left text-xs sm:text-sm font-medium text-gray-700">
                    Fecha
                  </th>
                  <th
                    className="px-2 py-2 sm:px-3 sm:py-2 md:px-4 md:py-3 text-left text-xs sm:text-sm font-medium text-gray-700">
              ...
              <tbody className="divide-y divide-gray-200">
                {documentData.map((doc, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-colors">
                    <td
                      className="px-2 py-2 sm:px-3 sm:py-2 md:px-4 md:py-3 text-xs sm:text-sm text-gray-900">
                      {doc.fecha}
                    </td>
                    <td
                      className="px-2 py-2 sm:px-3 sm:py-2 md:px-4 md:py-3 text-xs sm:text-sm text-gray-900 max-w-md">
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-600">Showing 1 to 5 of 50 entries</div>
            <div className="flex items-center gap-2">
