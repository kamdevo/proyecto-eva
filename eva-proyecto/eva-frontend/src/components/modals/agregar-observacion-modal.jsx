...
export function AgregarObservacionModal({ open, onOpenChange, equipo }) {
  ...
  const getFileIcon = (file) => {
    if (file.type.startsWith("image/"))
      return <ImageIcon className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600" />;
    if (file.type.startsWith("video/"))
      return <Video className="w-3 h-3 sm:w-4 sm:h-4 text-purple-600" />;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-2xl mx-auto max-h-[90vh] overflow-y-auto">
        <DialogHeader className="border-b border-blue-200 pb-3 sm:pb-4">
          ...
          <div className="h-1 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mt-2 sm:mt-3"></div>
        </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <Select value={responsable} onValueChange={setResponsable}>
                ...
                <SelectContent>
                  <SelectItem value="ingenieros-biomedicos">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              >
                ...
                <div className="text-slate-500 text-xs sm:text-sm mb-1">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 sm:p-4">
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="text-xs sm:text-sm text-amber-800">
                  <strong>Nota:</strong> Esta observación se registrará en el
                  historial del equipo y será visible para todos los usuarios
                  con acceso al sistema de mantenimiento.
                </div>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-slate-200">
              <Button
                type="button"
                variant="outline"
