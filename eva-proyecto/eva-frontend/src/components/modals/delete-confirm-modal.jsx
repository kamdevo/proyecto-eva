...
import { deleteEquipment } from "../../services/httpService";
...
export function DeleteConfirmModal({
  ...
  const handleDelete = async () => {
    if (!equipment?.id) {
      toast.error("Error: No se puede eliminar, ID de equipo no válido");
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        if (onEquipmentDeleted) {
          onEquipmentDeleted(equipment.id);
        }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold text-red-700 border-b border-red-200 pb-2 flex items-center gap-2">
          ...
          <div className="text-center">
            ...
            <div className="bg-gray-50 p-4 rounded-lg text-left">
              <p className="text-sm text-gray-600 mb-2">
                <strong>ID:</strong> {equipment.equipo?.code || equipment.id}
              </p>
              <p className="text-sm text-gray-600 mb-2">
              ...
              <p className="text-sm text-gray-600">
                <strong>Marca:</strong> {equipment.equipo?.brand || "Sin marca"}{" "}
            ...
            <div className="bg-red-50 border border-red-200 p-3 rounded-lg mt-4">
              <p className="text-sm text-red-700">
                ...
                deshacer. Se eliminarán todos los datos asociados al equipo
                incluyendo:
              </p>
