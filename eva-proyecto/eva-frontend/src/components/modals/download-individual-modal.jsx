...
const availableContingencies = [
  ...
  { id: "002", descripcion: "Contingencia ecógrafo Doplex", fecha: "2024-04-19", estado: "Cerrado" },
  { id: "003", descripcion: "Ecógrafo para cirugía en Emergencias", fecha: "2024-04-18", estado: "Cerrado" },
]
      ...
      <DialogContent className="w-[95vw] max-w-2xl mx-auto max-h-[90vh] overflow-y-auto">
        <DialogHeader className="border-b border-teal-200 pb-3">
          <div className="flex items-center justify-between">
            <DialogTitle className="text-base sm:text-lg font-semibold text-slate-800">Buscar y Descargar</DialogTitle>
            <Button
              variant="ghost"
              size="sm"
        ...
        <div className="space-y-4 sm:space-y-6 py-4">
          ...
          <div className="space-y-4">
            <h3 className="text-sm sm:text-base font-medium text-slate-800">Buscar Contingencias</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input id="buscarFecha" type="date" className="h-8 sm:h-9 text-xs sm:text-sm" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label className="text-xs sm:text-sm font-medium text-slate-700">Estado</Label>
                <Select>
              ...
              <div className="space-y-2">
                <Label className="text-xs sm:text-sm font-medium text-slate-700">Origen</Label>
                <Select>
                  <SelectTrigger className="h-8 sm:h-9 text-xs sm:text-sm">
                    <SelectValue placeholder="Todos" />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                <Label className="text-xs sm:text-sm font-medium text-slate-700">Usuario</Label>
                <Select>
                  <SelectTrigger className="h-8 sm:h-9 text-xs sm:text-sm">
                    <SelectValue placeholder="Todos" />
                  </SelectTrigger>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="text-xs sm:text-sm font-medium text-slate-800">Resultados de Búsqueda</h4>
              <div className="flex gap-2">
                ...
                <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-medium text-slate-900 text-xs sm:text-sm">#{contingency.id}</span>
                      <span className="text-xs text-slate-500">{contingency.fecha}</span>
                      <span
                    ...
                    <div className="text-xs text-slate-600 truncate">{contingency.descripcion}</div>
                  </div>
          ...
          {/* Download Options */}
          <div className="space-y-4">
            <h4 className="text-xs sm:text-sm font-medium text-slate-800">Opciones de Descarga</h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-medium text-slate-900 text-xs sm:text-sm">Descargar PDF Individual</div>
                    <div className="text-xs text-slate-600">Contingencias seleccionadas en PDF</div>
                  </div>
              ...
              <div className="space-y-3">
                <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-medium text-slate-900 text-xs sm:text-sm">Descargar Excel</div>
                    <div className="text-xs text-slate-600">Todas las contingencias en Excel</div>
                  </div>
