...
export function ConcluirObservacionModal({ open, onOpenChange, equipo }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log(
      "Concluyendo observación:",
      { selectedObservacion, conclusion, resultado, equipoId: equipo?.id }
    )
    onOpenChange(false)
    // Limpiar formulario
        ...
        <DialogHeader className="border-b border-purple-200 pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <DialogTitle className="text-xl font-semibold text-slate-800">Concluir Observación</DialogTitle>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <div
            className="h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mt-3"></div>
        </DialogHeader>
        ...
        <div className="py-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <Label className="text-sm font-medium text-slate-700">Observación a Concluir *</Label>
              {observacionesPendientes.length === 0 ? (
                <div
                  className="text-center py-6 text-slate-500 border border-slate-200 rounded-lg">
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <Badge className={getPrioridadColor(obs.prioridad)}>
                              {obs.prioridad.charAt(0).toUpperCase() + obs.prioridad.slice(1)}
                            </Badge>
                          ...
                          <div className="text-xs text-slate-500 mt-1">
                            <span className="font-medium">Responsable:</span> {obs.responsable}
                          </div>
                        </div>
                        <div className="flex-shrink-0">
                          <input
                            ...
                            onChange={() => setSelectedObservacion(obs.id.toString())}
            ...
            {/* Resultado */}
            <div className="space-y-3">
              <Label htmlFor="resultado" className="text-sm font-medium text-slate-700">
                Resultado *
              </Label>
              <Select value={resultado} onValueChange={setResultado} required>
                ...
                <SelectContent>
                  <SelectItem value="resuelto">✅ Resuelto Satisfactoriamente</SelectItem>
                  <SelectItem value="parcial">⚠️ Resuelto Parcialmente</SelectItem>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-amber-800">
                  <strong>Importante:</strong> Al concluir una observación, esta se marcará como completada y se
                  registrará en el historial del equipo. Esta acción no se puede deshacer.
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <Button
                type="submit"
                disabled={!selectedObservacion || observacionesPendientes.length === 0}
