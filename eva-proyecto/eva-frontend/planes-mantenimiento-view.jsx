    ...
    <div
      ...
      <div className="mb-4 sm:mb-6 lg:mb-8">
        <div
          ...
          <div>
            <h1
              className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-slate-800 mb-1">
      ...
      <Card className="mb-4 sm:mb-6 shadow-lg">
        ...
        <CardContent className="p-3 sm:p-4 lg:p-6">
          <div
            className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
              ...
              <Button
                className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white h-8 sm:h-9 px-3 sm:px-4 text-xs sm:text-sm">
                📁 Explorar
              </Button>
            </div>
